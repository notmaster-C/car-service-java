...
public class TencentStorageTest {
    ...
    public void test() throws IOException {
        ...
        tencentStorage.store(new FileInputStream(test), testFile.length(), "image/png", "carservice.png");
        Resource resource = tencentStorage.loadAsResource("carservice.png");
        String url = tencentStorage.generateUrl("carservice.png");
