...
public class LocalStorageTest {
    ...
    public void test() throws IOException {
        ...
        localStorage.store(new FileInputStream(test), testFile.length(), "image/png", "carservice.png");
        Resource resource = localStorage.loadAsResource("carservice.png");
        String url = localStorage.generateUrl("carservice.png");
