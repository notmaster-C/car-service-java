...
import org.ysling.litemall.admin.service.AdminKeywordService;
...
public class AdminKeywordController {
    ...
    @PostMapping("/create")
    public Object create(@Valid @RequestBody LitemallKeyword keyword) {
    ...
    @PostMapping("/update")
    public Object update(@Valid @RequestBody LitemallKeyword keyword) {
        Object error = keywordService.validate(keyword);
        if (error != null) {
            return error;
        }
